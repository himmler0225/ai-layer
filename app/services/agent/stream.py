...
from app.services.agent.loop import (begin_tool_round, bootstrap_agent,
                                     complete_tool_round, finish_agent,
...
async def run_agent_stream(
    ...
    yield _sse(
        {
            "type": "error",
            "message": f"Agent did not finish within {ctx['max_iter']} iterations",
        }
    )
