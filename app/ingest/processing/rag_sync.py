...
async def _should_queue_summarize(product_id: str, total_raw: int) -> bool:
    """Queue summarize lần đầu hoặc khi raw tăng đủ lớn — tránh spam job."""
...
async def sync_comments_to_product_rag(
    *,
    product_hint: str,
    platform: str,
    video_id: str,
    ...
    """
    Ghi products + raw_reviews + curated_reviews.
    Trả product_id nếu đã sync; None nếu thiếu product_hint.
    """
